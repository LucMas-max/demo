...
@EnableJpaRepositories(basePackages = {"it.addestramento"}, entityManagerFactoryRef = "masterEntityManagerFactory", transactionManagerRef = "masterTransactionManager")
public class DatabaseConfig {
     ...
     */
    @Autowired
    private DatabaseConfigProperties masterDbProperties;
    ...
    public LocalContainerEntityManagerFactoryBean masterEntityManagerFactory() {
        ...
        em.setPackagesToScan("it.addestramento");
    ...
    private Properties hibernateProperties() {
        ...
        //properties.put(org.hibernate.cfg.Environment.DIALECT, "org.hibernate.dialect.MariaDBDialect");
